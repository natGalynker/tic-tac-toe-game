...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetGamesById = function onGetGamesById(event) {
	  var data = getFormFields(this);
	  console.log(data.id);
	  event.preventDefault();
	  api.getGamesById(data).done(ui.getGamesByIdSuccess).fail(ui.failure);
	};
	...
	var onUpdateGame = function onUpdateGame(marker, index, over) {
	  event.preventDefault();
	  api.updateGame(marker, index, over).done(ui.updateGameSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGamesById = function getGamesById(data) {
	  return $.ajax({
	...
	var updateGame = function updateGame(marker, index, over) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGamesByIdSuccess = function getGamesByIdSuccess(data) {
	  app.game = data.game;
	...
	module.exports = {
	  ...
	  getGamesByIdSuccess: getGamesByIdSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var handles = __webpack_require__(3);
	var turnTracker = 0;
	var marker = ' ';
	var index = void 0;
	var over = false;
	...
	var idlePlay = function idlePlay() {
		turnTracker = 0;
		over = false;
		currentPlayer = '';
		marker = ' ';
	...
	$(function () {
		...
		$('.main').on('click', 'div', function () {
			...
			if (isSquareFree(index)) {
				...
				var isWon = checkForWin();
				var doubleCheck = checkForDraw();
